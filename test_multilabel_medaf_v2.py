...
from core.multilabel_net_v2 import (
    MultiLabelMEDAFv2,
    PerClassGating,
...
def test_enhanced_diversity_loss():
    ...
    for div_type in diversity_types:
        ...
        div_loss_basic = enhancedMultiLabelAttnDiv(
            cams_list, targets, diversity_type=div_type
        )
        ...
        print(
            f"{div_type:>6} diversity - Basic: {div_loss_basic.item():.6f}, Enhanced: {div_loss_enhanced.item():.6f}"
        )
...
def test_end_to_end_training():
    ...
    train_loader = data.DataLoader(dataset, batch_size=8, shuffle=True, num_workers=0)
    ...
    for config_name, config_updates in configurations:
        ...
        results[config_name] = {"best_accuracy": best_acc, "final_metrics": metrics}
